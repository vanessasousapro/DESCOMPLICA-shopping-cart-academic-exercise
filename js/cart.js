...
function preencherCarrinho(produtos) {
    produtos.forEach(data => {
        adicionarAoCarrinho(data.title, data.image, data.description, data.price);
    });
...
function atualizarCarrinho() {
    ...
    carrinhoHTML.innerHTML = ''; // Limpa o conteúdo antes de adicionar novos produtos

    carrinho.forEach((produto, index) => {
        carrinhoHTML.innerHTML += `
        <div id='produto${index}' class='d-flex flex-row justify-content-between align-items-center pt-lg-12 md-12 pt-2 pb-3 border-botton mobile'>
